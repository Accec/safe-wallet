...
#[test]
fn send_transfer_allows_trc20_low_trx_when_energy_is_available() {
...
#[test]
fn send_transfer_blocks_trc20_when_energy_policy_is_enabled() {
    ...
    assert_eq!(error, WalletError::InsufficientEnergy);
    assert_eq!(
        rpc.paths(),
        vec![
            "/wallet/getaccount",
